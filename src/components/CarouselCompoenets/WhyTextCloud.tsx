const WhyTextCloud = () => {
  ...
  return (
    <section className="px-4 my-32 lg:px-0">
      ...
      {/* Cards Container */}
      <div className=" text-[#C0C3C2] p-4 rounded-lg overflow-x-auto">
        <table className="w-full min-w-[600px] text-left border-collapse border-2 border-[#263D4D] rounded-2xl bg-[#00050366] backdrop-blur-md">
          <thead>
            <tr className="">
              <th className="p-2 font-semibold border border-[#263D4D]">Feature</th>
              <th className="p-2 font-semibold border border-[#263D4D] ">TexorCloud</th>
              <th className="p-2 font-semibold border border-[#263D4D] ">AutoGPT</th>
              <th className="p-2 font-semibold border border-[#263D4D] ">Botpress</th>
              <th className="p-2 font-semibold border border-[#263D4D] ">n8n</th>
            </tr>
          </thead>
          <tbody>
            {features.map((feature, index) => (
              ...
              >
                <td className="p-2 border border-[#263D4D]  ">{feature.name}</td>
                ...
                <td className="p-2 border border-[#263D4D] ">
                  {feature.autoGPT === true ? (
                    <span className="text-background  p-1 w-6 h-6 flex items-center justify-center rounded-md bg-green-400">✔</span>
                ...
                <td className="p-2 border border-[#263D4D] ">
                  {feature.n8n === true ? (
                    ...
                    <span className="text-yellow-400">{feature.n8n.text}</span>
                  )}
                </td>
              </tr>
            ))}
